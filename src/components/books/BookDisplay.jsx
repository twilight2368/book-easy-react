...
export default function BookDisplay() {
  return (
    <div className=" relative w-11/12 h-96 duration-300 hover:scale-105 book-display overflow-hidden rounded-md">
      ...
      <div className=" absolute bottom-0 bg-black/75 w-full text-white text-center whitespace-nowrap text-nowrap book-name-display">
        <div className=" font-black text-lg nunito-font mt-0.5">Dune</div>
        <div className=" nunito-font mb-0.5">Frank Herbert</div>
      </div>
